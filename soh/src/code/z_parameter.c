        ...
        if ((button == 0) && (gSaveContext.minigameState == 1)) {
            ...
            if (ammo < 0) {
                ammo = 0;
                   ...
                   CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if (gSaveContext.equips.buttonItems[1] < 0xF0) {
            ...
            gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
            if (gSaveContext.equips.buttonItems[1] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
        ...
        if (gSaveContext.equips.buttonItems[2] < 0xF0) {
            ...
            gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
            if (gSaveContext.equips.buttonItems[2] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
        ...
        if (gSaveContext.equips.buttonItems[3] < 0xF0) {
            ...
            gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
            if (gSaveContext.equips.buttonItems[3] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
        ...
        if (CVarGetInteger(CVAR_ENHANCEMENT("DpadEquips"), 0) != 0) {
            ...
            if (gSaveContext.equips.buttonItems[4] < 0xF0) {
                ...
                gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
                if (gSaveContext.equips.buttonItems[4] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
            ...
            if (gSaveContext.equips.buttonItems[5] < 0xF0) {
                ...
                gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
                if (gSaveContext.equips.buttonItems[5] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
            ...
            if (gSaveContext.equips.buttonItems[6] < 0xF0) {
                ...
                gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
                if (gSaveContext.equips.buttonItems[6] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
            ...
            if (gSaveContext.equips.buttonItems[7] < 0xF0) {
                ...
                gDPSetCombineMode(OVERLAY_DISP++, G_CC_MODULATERGBA_PRIM, G_CC_MODULATERGBA_PRIM);
                if (gSaveContext.equips.buttonItems[7] == ITEM_BOW && CVarGetInteger("gMods.lilDavid.BombArrows.Active", 0)) {
